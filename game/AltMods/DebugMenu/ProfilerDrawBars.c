...
void DebugProfiler_ListAllDebugStats()
{
	...
	if ((sdata->gGT->timer & (16 - 1)) == 0)
	{
		...
		timeCpu = ptrSectArr[numSectionsUsed - 2].timeEnd - ptrSectArr[0].timeStart;
		...
		for (int i = 0; i < numSectionsUsed; i++)
		{
			...
			{
				timeGpu = ptrSectArr[i].posD - ptrSectArr[0].timeStart;
			}
...
// NGin Labs 60fps test
			...
			{
				timeRed = ptrSectArr[i].timeEnd - ptrSectArr[i].timeStart;
			}

			if (*(int *)&ptrSectArr[i].a == 0xff0000)
			{
				timeGreen = ptrSectArr[i].timeEnd - ptrSectArr[i].timeStart;
			}

			if (*(int *)&ptrSectArr[i].a == 0xff000000)
			{
				timeBlue = ptrSectArr[i].timeEnd - ptrSectArr[i].timeStart;
			}

			if (*(int *)&ptrSectArr[i].a == 0xff00ff00)
			{
				timePink = ptrSectArr[i].timeEnd - ptrSectArr[i].timeStart;
...
void Gx_To_Fx(u_long *startOT)
{
	...
	while (1)
	{
		...
		// 0x30 PolyG3
		case 0x30:
			if ((*(short *)&((POLY_G3 *)header)->r0 == *(short *)&((POLY_G3 *)header)->r1) &&
			    (*(short *)&((POLY_G3 *)header)->r1 == *(short *)&((POLY_G3 *)header)->r2) && (((POLY_G3 *)header)->b0 == ((POLY_G3 *)header)->b1) &&
		...
		// 0x38 PolyG4
		case 0x38:
			if ((*(short *)&((POLY_G4 *)header)->r0 == *(short *)&((POLY_G4 *)header)->r1) &&
			    (*(short *)&((POLY_G4 *)header)->r1 == *(short *)&((POLY_G4 *)header)->r2) &&
			    (*(short *)&((POLY_G4 *)header)->r2 == *(short *)&((POLY_G4 *)header)->r3) && (((POLY_G4 *)header)->b0 == ((POLY_G4 *)header)->b1) &&
			    (((POLY_G4 *)header)->b1 == ((POLY_G4 *)header)->b2) && (((POLY_G4 *)header)->b2 == ((POLY_G4 *)header)->b3))
			{
		...
		// PolyGT3
		case 0x34:
			if ((*(short *)&((POLY_GT3 *)header)->r0 == *(short *)&((POLY_GT3 *)header)->r1) &&
			    (*(short *)&((POLY_GT3 *)header)->r1 == *(short *)&((POLY_GT3 *)header)->r2) && (((POLY_GT3 *)header)->b0 == ((POLY_GT3 *)header)->b1) &&
		...
		// PolyGT4
		case 0x3c:
			if ((*(short *)&((POLY_GT4 *)header)->r0 == *(short *)&((POLY_GT4 *)header)->r1) &&
			    (*(short *)&((POLY_GT4 *)header)->r1 == *(short *)&((POLY_GT4 *)header)->r2) &&
			    (*(short *)&((POLY_GT4 *)header)->r2 == *(short *)&((POLY_GT4 *)header)->r3) && (((POLY_GT4 *)header)->b0 == ((POLY_GT4 *)header)->b1) &&
			    (((POLY_GT4 *)header)->b1 == ((POLY_GT4 *)header)->b2) && (((POLY_GT4 *)header)->b2 == ((POLY_GT4 *)header)->b3))
			{
