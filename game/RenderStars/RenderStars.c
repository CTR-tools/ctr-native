...
CTR_STATIC_ASSERT_LAYOUT(sizeof(TILE_1) == 0x0C);
CTR_STATIC_ASSERT_LAYOUT(offsetof(TILE_1, tag) == 0x00);
CTR_STATIC_ASSERT_LAYOUT(offsetof(TILE_1, r0) == 0x04);
CTR_STATIC_ASSERT_LAYOUT(offsetof(TILE_1, x0) == 0x08);
