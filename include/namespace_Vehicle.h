...
CTR_STATIC_ASSERT_LAYOUT(sizeof(struct MetaPhys) == 0x1C);
CTR_STATIC_ASSERT_LAYOUT(sizeof(DriverFunc) == sizeof(void *));
...
CTR_STATIC_ASSERT_LAYOUT(sizeof(struct DriverCheckpointState) == 0x2);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DriverCheckpointState, branchChoiceIndex) == 0x0);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct DriverCheckpointState, currentIndex) == 0x1);

CTR_STATIC_ASSERT_LAYOUT(sizeof(struct BotPhysics) == 0x34);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct BotPhysics, rotXZ) == 0x0);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct BotPhysics, driftTarget) == 0x2);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct BotPhysics, mulDrift) == 0x4);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct BotPhysics, simpTurnState) == 0x6);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct BotPhysics, turboMeter) == 0x8);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct BotPhysics, fireLevel) == 0xa);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct BotPhysics, squishCooldown) == 0xc);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct BotPhysics, reserved_0x5cc) == 0x10);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct BotPhysics, speedY) == 0x14);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct BotPhysics, speedLinear) == 0x18);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct BotPhysics, accel) == 0x1c);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct BotPhysics, velocity) == 0x28);
CTR_STATIC_ASSERT_LAYOUT(sizeof(((struct BotPhysics *)0)->accel) == 0xc);
CTR_STATIC_ASSERT_LAYOUT(sizeof(((struct BotPhysics *)0)->velocity) == 0xc);
CTR_STATIC_ASSERT_LAYOUT(sizeof(struct BotData) == 0x94);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct BotData, aiPhysics) == 0x24);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct BotData, reserved_0x5a0) == 0x8);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct BotData, reserved_0x5ac) == 0x14);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct BotData, positionBackup) == 0x58);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct BotData, ai_quadblock_checkpointIndex) == 0x72);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct BotData, reserved_0x628) == 0x90);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct BotData, estimateNavFrame) == 0x74);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct BotData, estimatePosition) == 0x74);
CTR_STATIC_ASSERT_LAYOUT(sizeof(((struct BotData *)0)->estimatePosition) == 0x6);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct BotData, estimateFlags) == 0x82);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct BotData, estimateTail) == 0x84);
...
CTR_STATIC_ASSERT_LAYOUT(sizeof(Actions) == 0x4);
...
CTR_STATIC_ASSERT_LAYOUT(sizeof(DriverCollisionFlags) == 0x2);
CTR_STATIC_ASSERT_LAYOUT(sizeof(RainCloudEffect) == 0x2);
CTR_STATIC_ASSERT_LAYOUT(sizeof(union VehEmitterSkidmark) == 0x10);
CTR_STATIC_ASSERT_LAYOUT(offsetof(union VehEmitterSkidmark, edge[0]) == 0x0);
CTR_STATIC_ASSERT_LAYOUT(offsetof(union VehEmitterSkidmark, edge[1]) == 0x8);
CTR_STATIC_ASSERT_LAYOUT(offsetof(union VehEmitterSkidmark, edge0) == 0x0);
CTR_STATIC_ASSERT_LAYOUT(offsetof(union VehEmitterSkidmark, color) == 0x6);
CTR_STATIC_ASSERT_LAYOUT(offsetof(union VehEmitterSkidmark, flags) == 0x7);
CTR_STATIC_ASSERT_LAYOUT(offsetof(union VehEmitterSkidmark, edge1) == 0x8);
CTR_STATIC_ASSERT_LAYOUT(sizeof(union VehEmitterWallScratch) == 0x18);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct VehGroundSkidsScratch, projected) == 0x0);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct VehGroundSkidsScratch, pushBuffer) == 0x18);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct VehGroundSkidsScratch, colorNear) == 0x1c);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct VehGroundSkidsScratch, colorFar) == 0x20);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct VehGroundSkidsScratch, segmentFlags) == 0x24);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct VehGroundSkidsScratch, currXY) == 0x28);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct VehGroundSkidsScratch, prevXY) == 0x4c);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct VehGroundSkidsScratch, currDepth) == 0x70);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct VehGroundSkidsScratch, prevDepth) == 0x94);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct VehGroundSkidsScratch, origin) == 0xb8);
CTR_STATIC_ASSERT_LAYOUT(sizeof(struct VehGroundSkidsScratch) == 0xc4);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct VehPhysCrashAiScratch, forward) == 0x0);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct VehPhysCrashAiScratch, matrix) == 0x10);
CTR_STATIC_ASSERT_LAYOUT(sizeof(struct VehPhysCrashAiScratch) == 0x30);
...
CTR_STATIC_ASSERT_LAYOUT(sizeof(ForcedJumpType) == 0x1);
_Static_assert(FORCED_JUMP_NONE == 0);
_Static_assert(FORCED_JUMP_LOW == 1);
_Static_assert(FORCED_JUMP_HIGH == 2);
CTR_STATIC_ASSERT_LAYOUT(sizeof(RevEngineChargeState) == 0x1);
CTR_STATIC_ASSERT_LAYOUT(sizeof(RevEngineLockoutFlags) == 0x1);
CTR_STATIC_ASSERT_LAYOUT(sizeof(EngineSoundMode) == 0x1);

CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, ghostTape) == DRIVER_NTSC_RETAIL_SIZE);
CTR_STATIC_ASSERT_LAYOUT(sizeof(((struct Driver *)0)->funcPtrs) == DRIVER_FUNC_COUNT * sizeof(DriverFunc));
#if BUILD < EurRetail
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, funcPtrs) == 0x54);
#else
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, funcPtrs) == 0x58);
#endif
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, collisionFlags) == 0xaa);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, spsHitPos) == 0xac);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, padding_0xb2) == 0xb2);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, spsNormalVec) == 0xb4);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, padding_0xba) == 0xba);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, stepFlagSet) == 0xbc);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, skidmarks) == 0xc4);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, skidmarkEnableFlags) == 0x2c4);
CTR_STATIC_ASSERT_LAYOUT(sizeof(((struct Driver *)0)->stepFlagSet) == 0x4);
CTR_STATIC_ASSERT_LAYOUT(sizeof(((struct Driver *)0)->spsHitPosRaw) == 0x8);
CTR_STATIC_ASSERT_LAYOUT(sizeof(((struct Driver *)0)->spsNormalVecRaw) == 0x8);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, padding_0x3e) == 0x3e);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, actionsFlagSet) == 0x2c8);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, actionsFlagSetPrevFrame) == 0x2cc);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, forcedJumpType) == 0x366);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, AxisAngle2_normalVec) == 0x368);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, speedometerNeedleValue) == 0x36e);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, AxisAngle3_normalVec) == 0x370);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, AxisAngle4_normalVec) == 0x378);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, padding_0x37e) == 0x37e);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, failedBoostExhaustTimer) == 0x381);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, forwardAccelVector) == 0x3ac);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, forwardAccelImpulse) == 0x3b2);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, engineSoundVolumeState) == 0x3b6);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, engineSoundPitchState) == 0x3b8);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, tireColorCycleTimer) == 0x3bc);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, tireColorCycleStep) == 0x3be);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, accelTapWindowTimer) == 0x3c0);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, accelTapCount) == 0x3c2);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, terrainScaledBaseSpeed) == 0x3c4);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, turnWobbleAngle) == 0x3d4);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, turnWobbleVelocity) == 0x3d6);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, turnWobbleTimer) == 0x3d8);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, jump_HighJumpTimerMS) == 0x3fa);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, posWallColl) == 0x384);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, wallRubSpeedLimit) == 0x38a);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, padding_0x398) == 0x398);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, wallRubTimer) == 0x3fe);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, vShiftStartGuardTimer) == 0x406);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, vShiftWindowTimer) == 0x408);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, vShiftCount) == 0x40a);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, reserved_0x40e) == 0x40e);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, reserved_0x412) == 0x412);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, const_PreTurbo) == 0x440);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, const_SteerAccelTurnVelScale) == 0x44e);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, const_SteerAccelTurnVelLimit) == 0x450);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, const_ModelTurnCounterSteerStrength) == 0x457);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, const_ModelTurnReturnStrength) == 0x458);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, const_ModelTurnNegativeReturnStrength) == 0x459);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, const_ModelTurnVelocityLerp) == 0x45a);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, padding_0x45b) == 0x45b);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, const_DriftTurnBase) == 0x460);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, const_DriftTurnStartupScale) == 0x461);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, const_DriftTurnRampFrames) == 0x462);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, const_Drifting_FramesTillSpinout) == 0x463);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, const_DriftSpinRateAccel) == 0x464);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, const_DriftSpinRateDecel) == 0x466);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, const_Drifting_CameraSpinRate) == 0x468);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, const_DriftCameraLerpStep) == 0x46a);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, const_DriftReleaseTurnAssistFrames) == 0x46b);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, const_MetaPhys33) == 0x46c);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, const_MetaPhys34) == 0x46e);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, const_DriftTurnSameDirectionAngle) == 0x470);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, const_DriftTurnOppositeDirectionAngle) == 0x472);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, const_DriftTurnAngleScale) == 0x474);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, const_turboFullBarReserveGain) == 0x478);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, const_DriftBoostDurationFrames) == 0x479);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, const_DriftBoostAxisKickRate) == 0x47a);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, engineSoundMode) == 0x47b);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, checkpoint) == 0x494);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, checkpoint.branchChoiceIndex) == 0x494);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, checkpoint.currentIndex) == 0x495);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, BattleHUD.reserved_0x4d8) == 0x4d8);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, pendingDamageType) == 0x4ff);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, pendingDamageAttacker) == 0x500);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, pendingDamageReasonByte) == 0x504);
CTR_STATIC_ASSERT_LAYOUT(sizeof(((struct Driver *)0)->pendingDamageReasonPadding) == 0x3);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, rainCloudEffect) == 0x50a);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, numTimesWumpa) == 0x569);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, ghostPadding_0x636) == 0x636);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, KartStates.RevEngine.overRevTimerMS) == 0x58c);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, KartStates.RevEngine.releaseCooldownTimerMS) == 0x58e);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, KartStates.RevEngine.emptyCooldownTimerMS) == 0x590);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, KartStates.RevEngine.chargeState) == 0x592);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, KartStates.RevEngine.lockoutFlags) == 0x593);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, rotCurr.x) == 0x2ec);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, rotCurr.y) == 0x2ee);
CTR_STATIC_ASSERT_LAYOUT(offsetof(struct Driver, KartStates.MaskGrab.AngleAxis_NormalVec) == 0x584);
