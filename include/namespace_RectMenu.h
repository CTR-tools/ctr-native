...
CTR_STATIC_ASSERT_LAYOUT(sizeof(struct MenuRow) == 6);
#if BUILD != SepReview
CTR_STATIC_ASSERT_LAYOUT(sizeof(struct RectMenu) == 0x2C);
#else
CTR_STATIC_ASSERT_LAYOUT(sizeof(struct RectMenu) == 0x34);
#endif
